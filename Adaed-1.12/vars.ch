 ...
 *	2	full trace.
 */
X int iot_ifile INIT(0); /* current trace level for ifile */
X int iot_ofile INIT(0); /* current trace level for ofile */
X int iot_ais_r INIT(0); /* trace level for ais files read */
X int iot_ais_w INIT(0); /* trace level for ais files written */
X int iot_tre_r INIT(0); /* trace level for tre files read */
X int iot_tre_w INIT(0); /* trace level for tre files written */
X int iot_lib_r INIT(0); /* trace level for lib files read */
X int iot_lib_w INIT(0);/* set to trace writing lib file */
X char iot_ofile_type;
X char iot_ifile_type;
